...
MatrixXd V, V2, V_max(1, 3), color_per_face, NV,IM;
/*
...
MatrixXi F, F2, F_max(1, 3), Components_P_F, Components_P_V, NF;
/*
...
int main(int argv, char* argc[]) {
	...
	//	viewer_on = true;
	//}
	//"C:/Users/admin/csyhping/MeshRepair/coffeecup.off"
	// read off file 
	//load_file_off(argc[1], V, F);
	load_file_off("C:/Users/admin/csyhping/MeshRepair/coffeecup.off", V, F);
